      ...
      <View style={[{backgroundColor:'#eaf0ff' , height:'100%', }]}>
            ...
            <View style={[{display:'flex', alignItems:'center', justifyContent:'center', height:'60%' , gap:30}]}>
                ...
                <View style={[{gap:40 }]}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('ListedProducts')}  style={[{ backgroundColor: "#ff8e00" , height: 43 , width: 301 , borderRadius: 50, alignItems: 'center', justifyContent:'center', display:'flex' }]}>
                        <Text style={[{ color: "white" , fontSize: 15 , fontFamily: 'poppins' }]}>View Listed Products</Text>
                    </TouchableOpacity>
